...
class HomeCubit extends Cubit<HomeState> {
  ...
  HomeCubit(this.getAutoUseCase, {required this.getWeatherUseCase}) : super(const HomeState());
  ...
  void addWeatherItem(WeatherResponseEntity newWeather) {
    final updatedList = List<WeatherResponseEntity>.from(state.weatherList)..add(newWeather);
